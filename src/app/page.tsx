  ...
  return (
    <div className={cn("min-h-screen transition-colors duration-300", isDarkMode ? "dark" : "")}>
      <div className="min-h-screen bg-background text-foreground">
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-8 py-8" style={{ maxWidth: '1400px' }}>
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 mb-8 lg:mt-4">
            {/* 左侧内容 */}
                  ...
                  <div className="flex gap-3 animate-scroll-right">
                    {[...svgs
                      ...
                      .slice(0, 12)].map((svg, index) => (
                        <div key={`${svg.id}-${index}`} className="w-12 h-12 md:w-16 md:h-16 bg-card border border-border rounded-lg flex items-center justify-center p-2 flex-shrink-0">
                          <img
